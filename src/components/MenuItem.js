    ...
    const gameList = [
        {
            ...
            name: "Dots Training",
            gameTutorial: [
                { id: 1, tutor: "adjasqwjjknakasnknenjkncdsncknnensdmcsdcmsdcdscds." },
                { id: 2, tutor: "adjasqwjjknakasnknenjkncdsncknnensdmcsdcmsdcdscds." },
            ],
                    ...
                    <span key={filteredItem.id}>
                        ...
                        <div className="col">
                            <div className="row h-100 justify-content-end align-content-center flex-column">
                                <div className="col-auto">
                                    <NavLink to={filteredItem.link} className="btn btn-light">
                                        Start
                                    </NavLink>
                                </div>
                            </div>
